  ...
  return (
    <div className="bg-zinc-100 p-6 min-h-screen pt-30">
      ...
      <div className="pt-10">
        ...
        {/* Outer box - 90vw on small screens, full width on md and up */}
        <div className="bg-white rounded-md shadow border border-gray-200 max-w-[90vw] md:max-w-full overflow-hidden">
